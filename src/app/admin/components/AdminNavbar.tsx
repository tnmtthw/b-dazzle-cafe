...
//               {/* Only show action button on product management page */}
//               {getCurrentPageTitle() === 'Product Management' && (
//                 <button className="hidden md:flex items-center bg-brown-primary hover:bg-brown-primary-hover text-white py-2 px-4 rounded-lg transition-colors text-sm">
